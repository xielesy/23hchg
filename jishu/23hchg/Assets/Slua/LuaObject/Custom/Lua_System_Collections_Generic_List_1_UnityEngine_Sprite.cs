...
public class Lua_System_Collections_Generic_List_1_UnityEngine_Sprite : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			System.Collections.Generic.List<UnityEngine.Sprite> o;
			if(argc==1){
				o=new System.Collections.Generic.List<UnityEngine.Sprite>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<UnityEngine.Sprite>))){
				System.Collections.Generic.IEnumerable<UnityEngine.Sprite> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<UnityEngine.Sprite>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			...
			#endif
			#endif
			System.Collections.Generic.List<UnityEngine.Sprite> self=(System.Collections.Generic.List<UnityEngine.Sprite>)checkSelf(l);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				UnityEngine.Sprite a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<UnityEngine.Sprite> a2;
				...
				System.Collections.Generic.IComparer<UnityEngine.Sprite> a4;
	...
	static public int Exists(IntPtr l) {
		try {
			...
			#endif
			System.Collections.Generic.List<UnityEngine.Sprite> self=(System.Collections.Generic.List<UnityEngine.Sprite>)checkSelf(l);
			System.Predicate<UnityEngine.Sprite> a1;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				System.Predicate<UnityEngine.Sprite> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<UnityEngine.Sprite> a3;
	...
	static public int ForEach(IntPtr l) {
		try {
			...
			#endif
			System.Collections.Generic.List<UnityEngine.Sprite> self=(System.Collections.Generic.List<UnityEngine.Sprite>)checkSelf(l);
			System.Action<UnityEngine.Sprite> a1;
			checkDelegate(l,2,out a1);
			self.ForEach(a1);
			pushValue(l,true);
			return 1;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<UnityEngine.Sprite> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<UnityEngine.Sprite>))){
				System.Collections.Generic.List<UnityEngine.Sprite> self=(System.Collections.Generic.List<UnityEngine.Sprite>)checkSelf(l);
				System.Comparison<UnityEngine.Sprite> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<UnityEngine.Sprite>))){
				System.Collections.Generic.List<UnityEngine.Sprite> self=(System.Collections.Generic.List<UnityEngine.Sprite>)checkSelf(l);
				System.Collections.Generic.IComparer<UnityEngine.Sprite> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<UnityEngine.Sprite> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"List<<UnityEngine.Sprite, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null>>");
		addMember(l,Add);
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<UnityEngine.Sprite>));
	}
}
